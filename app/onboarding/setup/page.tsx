    ...
    <div className="min-h-screen bg-cream flex flex-col px-6 py-12 max-w-lg mx-auto">
      ...
      <div className="flex items-center gap-2 mb-8">
        {[1, 2].map((s) => (
          <div key={s} className="flex items-center gap-2">
            ...
            {s < 2 && (
              <div className={cn("flex-1 h-0.5 w-12 rounded", step > s ? "bg-brand-400" : "bg-gray-200")} />
            )}
          </div>
        ))}
      </div>
      ...
      {step === 1 && (
        <div className="animate-fade-in flex-1">
          ...
          <p className="text-sm text-gray-400 mb-6">Pick 3 or more genres to personalize your experience.</p>
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    active
                      ? "bg-brand-500 text-white border-brand-500 shadow-float"
                      : "bg-white text-gray-600 border-gray-100 shadow-card"
                  )}
                >
      ...
      {step === 2 && (
        <div className="animate-fade-in flex-1">
          ...
          <p className="text-sm text-gray-400 mb-6">How many books do you want to read this year?</p>
            ...
            {GOALS.map(({ value, label, desc }) => (
              <button
                ...
                className={cn(
                  ...
                  selectedGoal === value
                    ? "bg-brand-50 border-brand-400 shadow-float"
                ...
                <div>
                  <p
                    className={cn(
                      ...
                      selectedGoal === value ? "text-brand-700" : "text-gray-900"
                    )}
                  >
                    {label}
                  </p>
